...
def is_overnight_hours() -> bool:
    """
    Returns True if current time is during overnight hours (00:00-08:00 CST).
    During these hours, bot will NOT enter new positions.
    """
        ...
        while True:
            ...
            if manager.in_position:
                ...
                if outcome:
                    ...
                    # than that or it decapitates trades before the mean-reversion thesis can play out.
                    if candles_held >= config.BREAKEVEN_HOLD_CANDLES and unrealized_pnl < 0:
